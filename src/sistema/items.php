...
<body>
  ...
  <div class="container">
    ...
    <ul class="nav nav-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#ingredientes">Ingredientes</a>
      </li>
      <li class="nav-item">
      ...
      <div id="pociones" class="container tab-pane active">
        ...
        if ($res_pociones->num_rows > 0) {
          while ($pocion = $res_pociones->fetch_assoc()) {
            ...
            <div id="pocion-<?=$pocion["id"];?>" class="my-4">
              <h4>
        ...
        <div id="ingredientes" class="container tab-pane">
          ...
          if ($res->num_rows > 0) {
            while ($ing = $res->fetch_assoc()) { ?>
              <div id="ingrediente-<?=$ing["id"];?>" class="my-2">
                <h4><?=utf8_encode($ing["nom"]);?></h4>
                <ul style="list-style:none">
                  <li><b>Aspecto:</b> <?=utf8_encode($ing["descr"]);?></li>
                  <li><b>Localización:</b> <?=utf8_encode($ing["local"]);?></li>
                  <li><b>Propiedades:</b> <?=utf8_encode($ing["prop"]);?></li>
                </ul>
              </div>
              <hr>
            <?php }
